...
class MedicationsScreen extends StatefulWidget {
  ...
  final dob;
  final gender;
  MedicationsScreen({Key key, @required this.authToken,@required this.national_id,@required this.patientName,@required this.dob,@required this.gender}):super(key:key);
  @override
